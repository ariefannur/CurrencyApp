...
@class SharedDataState<__covariant T>, SharedUseCase<__covariant Type, __contravariant Params>, SharedCurrency, SharedThrottling, SharedDataStateFailure, SharedKotlinNothing, SharedDataStateLoading, SharedDataStateSuccess<T>, SharedCurrencyResponseCompanion, SharedCurrencyResponse, SharedDatabaseDriverFactory, SharedDatabase, SharedKtor_client_coreHttpClient, SharedCurrency_, SharedCurrencyDatabaseCompanion, SharedRuntimeQuery<__covariant RowType>, SharedKoin_coreModule, SharedKotlinx_serialization_jsonJson, SharedKoin_coreKoinApplication, SharedRuntimeTransacterTransaction, SharedKotlinThrowable, SharedKotlinArray<T>, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKtor_client_coreHttpClientEngineConfig, SharedKtor_client_coreHttpClientConfig<T>, SharedKtor_eventsEvents, SharedKtor_client_coreHttpReceivePipeline, SharedKtor_client_coreHttpRequestPipeline, SharedKtor_client_coreHttpResponsePipeline, SharedKtor_client_coreHttpSendPipeline, SharedKoin_coreInstanceFactory<T>, SharedKotlinPair<__covariant A, __covariant B>, SharedKoin_coreScope, SharedKoin_coreParametersHolder, SharedKoin_coreScopeDSL, SharedKoin_coreSingleInstanceFactory<T>, SharedKtor_client_coreHttpRequestData, SharedKtor_client_coreHttpResponseData, SharedKotlinx_coroutines_coreCoroutineDispatcher, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_jsonJsonDefault, SharedKotlinx_serialization_jsonJsonElement, SharedKotlinx_serialization_jsonJsonConfiguration, SharedKoin_coreKoinApplicationCompanion, SharedKoin_coreLogger, SharedKoin_coreLevel, SharedKoin_coreKoin, SharedKotlinByteArray, SharedKotlinx_serialization_coreSerialKind, SharedKtor_client_coreProxyConfig, SharedKtor_utilsAttributeKey<T>, SharedKtor_eventsEventDefinition<T>, SharedKtor_utilsPipelinePhase, SharedKtor_utilsPipeline<TSubject, TContext>, SharedKtor_client_coreHttpReceivePipelinePhases, SharedKtor_client_coreHttpResponse, SharedKotlinUnit, SharedKtor_client_coreHttpRequestPipelinePhases, SharedKtor_client_coreHttpRequestBuilder, SharedKtor_client_coreHttpResponsePipelinePhases, SharedKtor_client_coreHttpResponseContainer, SharedKtor_client_coreHttpClientCall, SharedKtor_client_coreHttpSendPipelinePhases, SharedKoin_coreLockable, SharedKoin_coreBeanDefinition<T>, SharedKoin_coreInstanceFactoryCompanion, SharedKoin_coreInstanceContext, SharedKotlinLazyThreadSafetyMode, SharedKoin_coreParametersHolderCompanion, SharedKtor_httpUrl, SharedKtor_httpHttpMethod, SharedKtor_httpOutgoingContent, SharedKtor_httpHttpStatusCode, SharedKtor_utilsGMTDate, SharedKtor_httpHttpProtocolVersion, SharedKotlinAbstractCoroutineContextElement, SharedKotlinx_coroutines_coreCoroutineDispatcherKey, SharedKotlinx_serialization_jsonJsonElementCompanion, SharedKotlinEnumCompanion, SharedKotlinEnum<E>, SharedKoin_coreInstanceRegistry, SharedKoin_corePropertyRegistry, SharedKoin_coreScopeRegistry, SharedKotlinByteIterator, SharedKtor_httpHeadersBuilder, SharedKtor_client_coreHttpRequestBuilderCompanion, SharedKtor_httpURLBuilder, SharedKtor_utilsTypeInfo, SharedKtor_client_coreHttpClientCallCompanion, SharedKoin_coreKind, SharedKoin_coreCallbacks<T>, SharedKtor_httpUrlCompanion, SharedKtor_httpURLProtocol, SharedKtor_httpHttpMethodCompanion, SharedKtor_httpContentType, SharedKotlinCancellationException, SharedKtor_httpHttpStatusCodeCompanion, SharedKtor_utilsGMTDateCompanion, SharedKtor_utilsWeekDay, SharedKtor_utilsMonth, SharedKtor_httpHttpProtocolVersionCompanion, SharedKotlinAbstractCoroutineContextKey<B, E>, SharedKoin_coreScopeRegistryCompanion, SharedKtor_ioMemory, SharedKtor_ioChunkBuffer, SharedKtor_ioBuffer, SharedKtor_ioByteReadPacket, SharedKtor_utilsStringValuesBuilderImpl, SharedKtor_httpURLBuilderCompanion, SharedKtor_httpURLProtocolCompanion, SharedKtor_httpHeaderValueParam, SharedKtor_httpHeaderValueWithParametersCompanion, SharedKtor_httpHeaderValueWithParameters, SharedKtor_httpContentTypeCompanion, SharedKtor_utilsWeekDayCompanion, SharedKtor_utilsMonthCompanion, SharedKtor_ioMemoryCompanion, SharedKtor_ioBufferCompanion, SharedKtor_ioChunkBufferCompanion, SharedKtor_ioInputCompanion, SharedKtor_ioInput, SharedKtor_ioByteReadPacketCompanion, SharedKotlinKTypeProjection, SharedKotlinx_coroutines_coreAtomicDesc, SharedKotlinx_coroutines_coreLockFreeLinkedListNodePrepareOp, SharedKotlinKVariance, SharedKotlinKTypeProjectionCompanion, SharedKotlinx_coroutines_coreAtomicOp<__contravariant T>, SharedKotlinx_coroutines_coreOpDescriptor, SharedKotlinx_coroutines_coreLockFreeLinkedListNode, SharedKotlinx_coroutines_coreLockFreeLinkedListNodeAbstractAtomicDesc, SharedKotlinx_coroutines_coreLockFreeLinkedListNodeAddLastDesc<T>, SharedKotlinx_coroutines_coreLockFreeLinkedListNodeRemoveFirstDesc<T>;

@protocol SharedRuntimeSqlDriver, SharedKotlinx_coroutines_coreCoroutineScope, SharedKotlinx_coroutines_coreFlow, SharedCurrencyRepository, SharedKotlinx_serialization_coreKSerializer, SharedCurrencyDatabase, SharedCurrencyQueries, SharedCurrencyLocalDataSource, SharedCurrencyRemoteDataSource, SharedRuntimeTransactionWithoutReturn, SharedRuntimeTransactionWithReturn, SharedRuntimeTransacter, SharedRuntimeSqlDriverSchema, SharedKtor_client_coreHttpClientEngine, SharedRuntimeSqlPreparedStatement, SharedRuntimeSqlCursor, SharedRuntimeCloseable, SharedKotlinCoroutineContext, SharedKotlinx_coroutines_coreFlowCollector, SharedKotlinx_serialization_coreEncoder, SharedKotlinx_serialization_coreSerialDescriptor, SharedKotlinx_serialization_coreSerializationStrategy, SharedKotlinx_serialization_coreDecoder, SharedKotlinx_serialization_coreDeserializationStrategy, SharedKtor_ioCloseable, SharedKtor_client_coreHttpClientEngineCapability, SharedKtor_utilsAttributes, SharedRuntimeTransactionCallbacks, SharedRuntimeQueryListener, SharedKoin_coreQualifier, SharedKotlinx_serialization_coreSerialFormat, SharedKotlinx_serialization_coreStringFormat, SharedKotlinIterator, SharedKotlinCoroutineContextElement, SharedKotlinCoroutineContextKey, SharedKotlinx_serialization_coreCompositeEncoder, SharedKotlinAnnotation, SharedKotlinx_serialization_coreCompositeDecoder, SharedKtor_client_coreHttpClientPlugin, SharedKotlinx_coroutines_coreDisposableHandle, SharedKotlinSuspendFunction2, SharedKotlinKClass, SharedKotlinLazy, SharedKoin_coreScopeCallback, SharedKtor_httpHeaders, SharedKotlinx_coroutines_coreJob, SharedKotlinContinuation, SharedKotlinContinuationInterceptor, SharedKotlinx_coroutines_coreRunnable, SharedKotlinx_serialization_coreSerializersModuleCollector, SharedKotlinComparable, SharedKoin_coreKoinScopeComponent, SharedKotlinFunction, SharedKtor_httpHttpMessage, SharedKtor_ioByteReadChannel, SharedKtor_httpHttpMessageBuilder, SharedKtor_client_coreHttpRequest, SharedKotlinKDeclarationContainer, SharedKotlinKAnnotatedElement, SharedKotlinKClassifier, SharedKtor_httpParameters, SharedKotlinMapEntry, SharedKtor_utilsStringValues, SharedKotlinx_coroutines_coreChildHandle, SharedKotlinx_coroutines_coreChildJob, SharedKotlinSequence, SharedKotlinx_coroutines_coreSelectClause0, SharedKoin_coreKoinComponent, SharedKtor_ioReadSession, SharedKotlinSuspendFunction1, SharedKotlinAppendable, SharedKtor_utilsStringValuesBuilder, SharedKtor_httpParametersBuilder, SharedKotlinKType, SharedKotlinx_coroutines_coreParentJob, SharedKotlinx_coroutines_coreSelectInstance, SharedKotlinSuspendFunction0, SharedKtor_ioObjectPool;
...
@interface SharedUseCase<__covariant Type, __contravariant Params> : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)invokeParams:(Params _Nullable)params scope:(id<SharedKotlinx_coroutines_coreCoroutineScope>)scope callback:(void (^)(SharedDataState<Type> *))callback __attribute__((swift_name("invoke(params:scope:callback:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)runParams:(Params _Nullable)params completionHandler:(void (^)(id<SharedKotlinx_coroutines_coreFlow> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("run(params:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ConvertCurrency")))
@interface SharedConvertCurrency : SharedUseCase<NSArray<SharedCurrency *> *, SharedCurrency *>
- (instancetype)initWithRepository:(id<SharedCurrencyRepository>)repository __attribute__((swift_name("init(repository:)"))) __attribute__((objc_designated_initializer));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)runParams:(SharedCurrency *)params completionHandler:(void (^)(id<SharedKotlinx_coroutines_coreFlow> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("run(params:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Throttling")))
@interface SharedThrottling : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)throttling __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedThrottling *shared __attribute__((swift_name("shared")));
- (BOOL)isAllowToCallApi __attribute__((swift_name("isAllowToCallApi()")));
- (void)start __attribute__((swift_name("start()")));
@end

__attribute__((swift_name("CurrencyLocalDataSource")))
@protocol SharedCurrencyLocalDataSource
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getCurrencyWithCompletionHandler:(void (^)(SharedMutableDictionary<NSString *, SharedDouble *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getCurrency(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getRateKey:(NSString *)key completionHandler:(void (^)(SharedDouble * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getRate(key:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)saveCurrencyData:(SharedMutableDictionary<NSString *, SharedDouble *> *)data completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("saveCurrency(data:completionHandler:)")));
@end

__attribute__((swift_name("CurrencyRemoteDataSource")))
@protocol SharedCurrencyRemoteDataSource
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)requestCurrencyWithCompletionHandler:(void (^)(SharedMutableDictionary<NSString *, SharedDouble *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("requestCurrency(completionHandler:)")));
@end

__attribute__((swift_name("CurrencyRepository")))
@protocol SharedCurrencyRepository
@required
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DataStateFailure")))
@interface SharedDataStateFailure : SharedDataState<SharedKotlinNothing *>
...
- (SharedDataStateFailure *)doCopyErrorCode:(int32_t)errorCode message:(NSString *)message __attribute__((swift_name("doCopy(errorCode:message:)")));
...
@property (class, readonly, getter=shared) SharedDataStateLoading *shared __attribute__((swift_name("shared")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DataStateSuccess")))
@interface SharedDataStateSuccess<T> : SharedDataState<T>
- (instancetype)initWithResult:(T)result __attribute__((swift_name("init(result:)"))) __attribute__((objc_designated_initializer));
- (SharedDataStateSuccess<T> *)doCopyResult:(T)result __attribute__((swift_name("doCopy(result:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) T result __attribute__((swift_name("result")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UseCaseNone")))
@interface SharedUseCaseNone : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@end
...
- (instancetype)initWithCode:(NSString *)code rate:(double)rate __attribute__((swift_name("init(code:rate:)"))) __attribute__((objc_designated_initializer));
- (SharedCurrency *)doCopyCode:(NSString *)code rate:(double)rate __attribute__((swift_name("doCopy(code:rate:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *code __attribute__((swift_name("code")));
@property (readonly) double rate __attribute__((swift_name("rate")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CurrencyResponse")))
@interface SharedCurrencyResponse : SharedBase
- (instancetype)initWithTimestamp:(SharedLong * _Nullable)timestamp base:(NSString * _Nullable)base rates:(SharedMutableDictionary<NSString *, SharedDouble *> * _Nullable)rates __attribute__((swift_name("init(timestamp:base:rates:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedCurrencyResponseCompanion *companion __attribute__((swift_name("companion")));
- (SharedCurrencyResponse *)doCopyTimestamp:(SharedLong * _Nullable)timestamp base:(NSString * _Nullable)base rates:(SharedMutableDictionary<NSString *, SharedDouble *> * _Nullable)rates __attribute__((swift_name("doCopy(timestamp:base:rates:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="rates")
*/
@property (readonly) SharedMutableDictionary<NSString *, SharedDouble *> * _Nullable rates __attribute__((swift_name("rates")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CurrencyResponse.Companion")))
@interface SharedCurrencyResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCurrencyResponseCompanion *shared __attribute__((swift_name("shared")));
...
@property (readonly) id<SharedCurrencyDatabase> db __attribute__((swift_name("db")));
@property (readonly) id<SharedCurrencyQueries> dbQueries __attribute__((swift_name("dbQueries")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CurrencyLocalDataSourceImpl")))
@interface SharedCurrencyLocalDataSourceImpl : SharedBase <SharedCurrencyLocalDataSource>
- (instancetype)initWithDb:(SharedDatabase *)db __attribute__((swift_name("init(db:)"))) __attribute__((objc_designated_initializer));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CurrencyRemoteDataSourceImpl")))
@interface SharedCurrencyRemoteDataSourceImpl : SharedBase <SharedCurrencyRemoteDataSource>
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CurrencyRepositoryImpl")))
@interface SharedCurrencyRepositoryImpl : SharedBase <SharedCurrencyRepository>
- (instancetype)initWithRemote:(id<SharedCurrencyRemoteDataSource>)remote __attribute__((swift_name("init(remote:)"))) __attribute__((objc_designated_initializer));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Currency_")))
@interface SharedCurrency_ : SharedBase
- (instancetype)initWithCode:(NSString *)code value_:(SharedDouble * _Nullable)value_ __attribute__((swift_name("init(code:value_:)"))) __attribute__((objc_designated_initializer));
- (SharedCurrency_ *)doCopyCode:(NSString *)code value_:(SharedDouble * _Nullable)value_ __attribute__((swift_name("doCopy(code:value_:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *code __attribute__((swift_name("code")));
...
__attribute__((swift_name("CurrencyDatabase")))
@protocol SharedCurrencyDatabase <SharedRuntimeTransacter>
@required
@property (readonly) id<SharedCurrencyQueries> currencyQueries __attribute__((swift_name("currencyQueries")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CurrencyDatabaseCompanion")))
@interface SharedCurrencyDatabaseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCurrencyDatabaseCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedCurrencyDatabase>)invokeDriver:(id<SharedRuntimeSqlDriver>)driver __attribute__((swift_name("invoke(driver:)")));
@property (readonly) id<SharedRuntimeSqlDriverSchema> Schema __attribute__((swift_name("Schema")));
@end

__attribute__((swift_name("CurrencyQueries")))
@protocol SharedCurrencyQueries <SharedRuntimeTransacter>
@required
- (void)insertCurrencyCode:(NSString *)code value_:(SharedDouble * _Nullable)value_ __attribute__((swift_name("insertCurrency(code:value_:)")));
- (SharedRuntimeQuery<SharedCurrency_ *> *)selectAll __attribute__((swift_name("selectAll()")));
- (SharedRuntimeQuery<id> *)selectAllMapper:(id (^)(NSString *, SharedDouble * _Nullable))mapper __attribute__((swift_name("selectAll(mapper:)")));
- (SharedRuntimeQuery<SharedCurrency_ *> *)selectOneCode:(NSString *)code __attribute__((swift_name("selectOne(code:)")));
- (SharedRuntimeQuery<id> *)selectOneCode:(NSString *)code mapper:(id (^)(NSString *, SharedDouble * _Nullable))mapper __attribute__((swift_name("selectOne(code:mapper:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ConversionKt")))
@interface SharedConversionKt : SharedBase

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
+ (void)toCurrency:(id<SharedCurrencyRepository>)receiver value:(double)value code:(NSString *)code completionHandler:(void (^)(NSArray<SharedCurrency *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("toCurrency(_:value:code:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PathKt")))
@interface SharedPathKt : SharedBase
...
@property (class, readonly) NSString *LATEST __attribute__((swift_name("LATEST")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("InjectionKt")))
@interface SharedInjectionKt : SharedBase
+ (SharedKoin_coreModule *)commonModuleEnableNetworkLogs:(BOOL)enableNetworkLogs __attribute__((swift_name("commonModule(enableNetworkLogs:)")));
+ (SharedKtor_client_coreHttpClient *)createHttpClientHttpClientEngine:(id<SharedKtor_client_coreHttpClientEngine>)httpClientEngine json:(SharedKotlinx_serialization_jsonJson *)json enableNetworkLogs:(BOOL)enableNetworkLogs __attribute__((swift_name("createHttpClient(httpClientEngine:json:enableNetworkLogs:)")));
...
+ (SharedKoin_coreKoinApplication *)doInitKoinEnableNetworkLogs:(BOOL)enableNetworkLogs appDeclaration:(void (^)(SharedKoin_coreKoinApplication *))appDeclaration __attribute__((swift_name("doInitKoin(enableNetworkLogs:appDeclaration:)")));
@end
